...
class ManagementApprovalCard extends StatelessWidget {
  const ManagementApprovalCard({
    super.key,
    required this.item,
  });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                AppTitleValueRow(
                  title: 'QC Remark',
                  value: item.qcRemark != null && item.qcRemark!.isNotEmpty
                      ? item.qcRemark!
                      : '',
                ),
                AppSpaces.v10,
                ...
                AppTitleValueRow(
                  title: 'Rate',
                  value: item.rate != null && item.rate!.toString().isNotEmpty
                      ? item.rate!.toString()
                      : '0',
                ),
                AppTitleValueRow(
                  title: 'Accounting Remark',
                  value: item.accRemark != null && item.accRemark!.isNotEmpty
                      ? item.accRemark!
                      : '',
                ),
                AppSpaces.v10,
