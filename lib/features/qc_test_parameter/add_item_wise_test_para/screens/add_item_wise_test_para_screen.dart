...
import 'package:shreeji_dairy/features/qc_test_parameter/add_item_wise_test_para/controllers/add_item_wise_test_para_controller.dart';
...
class AddItemWiseTestParaScreen extends StatelessWidget {
  AddItemWiseTestParaScreen({
    super.key,
  });

  final AddItemWiseTestParaController _controller = Get.put(
    AddItemWiseTestParaController(),
  );
                ...
                children: [
                  Obx(
                    () => AppDropdown(
                      ...
                      selectedItem: _controller.selectedItem.value.isNotEmpty
                  ...
                  AppButton(
                    ...
                    onPressed: () {
                      if (_controller.addedData.isNotEmpty) {
                        _controller.addItemwiseQcTestPara();
                      } else {
                        showErrorSnackbar(
                          'Oops!',
