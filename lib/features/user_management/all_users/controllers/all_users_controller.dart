...
import 'package:shreeji_dairy/features/user_management/all_users/repositories/all_users_repo.dart';
...
class AllUsersController extends GetxController {
  ...
  Future<void> getUsers() async {
    try {
      ...
      final fetchedUsers = await AllUsersRepo.getUsers();
      ...
      users.where(
        (user) {
          return user.firstName.toLowerCase().contains(
              ...
              user.mobileNo.toLowerCase().contains(
                    query.toLowerCase(),
                  );
        },
      ).toList(),
