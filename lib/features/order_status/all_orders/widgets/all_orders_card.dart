...
import 'package:shreeji_dairy/features/order_status/order_status_detail/screens/order_status_detail_screen.dart';
...
class AllOrdersCard extends StatelessWidget {
  const AllOrdersCard({
    super.key,
    required this.order,
  });
